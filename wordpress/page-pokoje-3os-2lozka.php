...
<section class="quote quote--pageHeading">
    <article>
        ...
        <blockquote>
            <p>Pokój 3-osobowy z 1 pojedynczym łóżkiem oraz 1 podwójnym. Pokój ten dysponuje łazienką i jest wyposażony w telewizor LCD z dostępem do kanałów telewizji satelitarnej.</p>
        </blockquote>
    </article>
</section>
<section>
            ...
            <div>
                <div class="room-header">
                    <div><h3>Pokoje 3-osobowe <i class="fa fa-star-o gold"></i><i class="fa fa-star-o gold"></i><i class="fa fa-star-o gold"></i></h3>
                        <p><i class="fa fa-bed" aria-hidden="true"></i> 1 podwójne, 1 pojedyncze <i class="fa fa-user" style="margin-left:20px" aria-hidden="true"></i> max. 3 osoby </p></div>
                    <div>
